    ...
    <body>
        ...
        <div id="content">
                    ...
                    <div id="main">                       
                        ...
                        <div id="news">
                            <h2 class="heading">Рефераты</h2>
                            <div style="clear: both"><br></div>
                            
                           
                            <div class="block">
                                <p>Пути ускорения оборачиваемости оборотных средств</p>
                                <form>
                                    
                                    <iframe src="/doc/referat/os.pdf" width=600 height=350></iframe> 
                            ...
                            <style>.block {margin: 0 0 5em 0}</style>
                            
                            <div class="block">
                               
                                <p>Издержки в долгосрочный и краткосрочный периоды</p>
                                <form>
                                    
                                    <iframe src="/doc/referat/izderzhki.pdf" width=600 height=350></iframe> 
